...
export const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/delta", label: "الشركة والعلامة" },
      { href: "/products", label: "الكتالوج كما نُشر" },
      { href: "/quality", label: "الجودة والصدق" },
    ],
  },
  {
    id: "growth",
    label: "النمو",
    items: [
      { href: "/contests", label: "محرّك تجزئة" },
      { href: "/schools", label: "قناة التشغيل" },
      { href: "/marketing", label: "رسائل المبيعات" },
      { href: "/education", label: "تمكين الفريق" },
      { href: "/reuse", label: "ما يبقى بعد الصفقة" },
    ],
  },
  {
    id: "operations",
    label: "العمليات",
    items: [
      { href: "/workflow", label: "من الطلب إلى التسليم" },
