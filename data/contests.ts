...
export const contestRules = [
  { title: "التسجيل", text: "التسجيل من واتساب المبيعات. تُفتح بطاقة تجزئة." },
  { title: "العدّ", text: "كل طلب أو زيارة تُسجَّل كنقاط تجريبية في هذا اللوح." },
  { title: "العتبة", text: "عند العتبة يُقترح إجراء. لا يُنفَّذ إلا باعتماد مدير المبيعات." },
  { title: "البيع", text: "عرض صنف شوكولاتة للتجزئة لا يُعتمد سعره إلا من المبيعات" },
  { title: "الصدق", text: "الموقع أعاد 403 للفحص الآلي. نلتزم بالبطاقة والمجموعة دون اختراع كتالوج." },
];
