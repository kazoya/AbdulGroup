...
const items = [
  { title: "جملة الإغلاق", text: "التاجر يريد صنفاً يتحرك من الرف. المنصة تقترح تشكيلة وأنت تعتمد" },
  { title: "ما يدرَّب عليه المندوب", text: "يعيد الوعد كما هو: عرض صنف شوكولاتة للتجزئة لا يُعتمد سعره إلا من المبيعات ثم يحول الرسالة بطاقة." },
